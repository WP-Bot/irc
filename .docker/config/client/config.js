...
module.exports = {                                                                
        ...
        // ### `public`                                                           
        //                                                                        
        // When set to `true`, The Lounge starts in public mode. When set to `fals
        // it starts in private mode.                                             
        //                                                                        
        // - A **public server** does not require authentication. Anyone can conne
        //   to IRC networks in this mode. All IRC connections and channel        
        //   scrollbacks are lost when a user leaves the client.                  
        // - A **private server** requires users to log in. Their IRC connections 
        //   kept even when they are not using or logged in to the client. All joi
        ...
        // ### `host`                                                             
        //                                                                        
        // IP address or hostname for the web server to listen to. For example, se
        ...
        // - `tls`: Enable TLS connections        // - `rejectUnauthorized`: Whether the server certificate should be verified
